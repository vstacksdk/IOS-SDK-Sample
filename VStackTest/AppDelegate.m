...
//    [[VStackManager instance] setPublicKey:@""];
    ...
    [[VStackManager instance] connectWithVStackUserId:@"user2" userCredentials:@"" fullname:@"user 2" completion:^(NSString *authenticatedVStackUserID, NSError *error, BOOL successful) {
        if (successful) {
