...
//    [[VStackManager instance] setPublicKey:@""];
    ...
    [[VStackManager instance] setLimitedTime:10000];
    ...
    [[VStackManager instance] connectWithVStackUserId:@"vstack" userCredentials:@"" fullname:@"vstack" completion:^(NSString *authenticatedVStackUserID, NSError *error, BOOL successful) {
        if (successful) {
